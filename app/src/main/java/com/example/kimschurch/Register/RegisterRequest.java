...
public class RegisterRequest extends StringRequest {
    ...
    public RegisterRequest(String image, String pnum, String name, String phone, String sex, String position, String department, String part, String srbName, String srbLeader,
                           String work, String birthday, String birthdayCal, String etc, Response.Listener<String> listener){
